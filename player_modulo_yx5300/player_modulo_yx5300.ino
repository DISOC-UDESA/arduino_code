/*
 * 
 * Ejemplo para reproducir audios escribiendo comandos en el Monitor Serie
 * Todos los comandos en la función "void sendMP3Command(char c)"
 *
 */

#include <SoftwareSerial.h>

#define ARDUINO_RX 13  // D7 del micro que se conecta a TX del módulo mp3
#define ARDUINO_TX 15  // D8 del micro que se conecta a RX del módulo mp3
